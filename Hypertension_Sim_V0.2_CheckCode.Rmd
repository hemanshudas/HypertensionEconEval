...
d.c   <- d.e <- 0                    #Equal discounting of costs and QALYs by 3%
...
Probs <- function(M.it,p.W_CVD) {
          ...
          v.p.it[M.it == "W"] <- c(1,0,0,0,0,0,0) #tranistion probability when well
          v.p.it[M.it == "MI"] <- c(0,0,0,0,0,0,0)                          #transition probability when in MI state
          v.p.it[M.it == "ST"] <- c(0,0,0,0,0,0,0)                          #transition probability when in Stroke state
          v.p.it[M.it == "postMI"] <- c(0,0,0,0,0,0,0)          #transition probability when in MI state
          v.p.it[M.it == "postST"] <- c(0,0,0,0,0,0,0)                          #transition probability when in Stroke state
